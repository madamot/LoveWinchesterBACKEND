"""
Django settings for winch_project project.
...
SECRET_KEY = 'xu!4o!s(l6&m1jl4bolybe^9!)jl9p86vtq03!mw2)lak0sx(_'
...
ROOT_URLCONF = 'winch_project.urls'
...
WSGI_APPLICATION = 'winch_project.wsgi.application'
